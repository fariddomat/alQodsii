...
@section('content')
        ...
        <div class="row match-height">
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <a href="{{ route('moderator.floors.destroy', $project->id) }}" class="btn btn-danger mr-3">تهيئة</a>
                    </div>
                </div>
            </div>
    ...
    @else
    <form action="{{ route('moderator.floors.store') }}" method="post">
        @extends('moderator._layouts._error')
        @csrf
                        ...
                        <div class="card-block" dir="rtl" style="text-align: right">
                            <div class="card-block " style="text-align: right">
                                <fieldset class="form-group">
                                    ...
                                    @include('moderator._layouts._error')
                                    <div class="col-lg-6">
