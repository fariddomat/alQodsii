        ...
        <div class="row">
            <div class="col-md-12 col-lg-6 blog-grid1-left-col wow fadeInLeft">
                <article class="blog-grid1-item zoom-cont">
                    <div class="blog-grid1-post-content">
                        ...
                        <a href="#" class="blog-grid1-title"><h4>It’s much cheaper to buy than to rent</h4></a>
                    ...
                    <figure class=""><a href="#"><img src="images/blog-grid1a.jpg" alt="" class="zoom" /></a></figure>
                </article>
            </div>
            <div class="col-md-12 col-lg-6 blog-grid1-right-col wow fadeInRight">
                <article class="blog-grid1-item zoom-cont">
                    ...
                    <figure class=""><a href="#"><img src="images/blog-grid1b.jpg" alt="" class="zoom" /></a></figure>
                </article>
            </div>
            <div class="col-md-12 col-lg-6 blog-grid1-left-col wow fadeInLeft">
                <article class="blog-grid1-item zoom-cont">
                    <figure class=""><a href="#"><img src="images/blog-grid1e.jpg" alt="" class="zoom" /></a></figure>
                    <div class="blog-grid1-post-content">
                        <div class="blog-grid1-topline">
                            <div class="blog-grid1-author pull-left"><i class="fa fa-user"></i>Admin</div>
                            <div class="blog-grid1-date pull-right"><i class="fa fa-calendar-o"></i>28/09/15</div>
            ...
            <div class="col-md-12 col-lg-6 blog-grid1-right-col wow fadeInRight">
                <article class="blog-grid1-item zoom-cont">
                    <figure class=""><a href="#"><img src="images/blog-grid1d.jpg" alt="" class="zoom" /></a></figure>
                    <div class="blog-grid1-post-content">
                        <div class="blog-grid1-topline">
                            <div class="blog-grid1-author pull-left"><i class="fa fa-user"></i>Admin</div>
                            <div class="blog-grid1-date pull-right"><i class="fa fa-calendar-o"></i>28/09/15</div>
