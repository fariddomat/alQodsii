        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.promoters.create') }}" class="btn btn-icon btn-info mr-1">@lang('site.create') <i
                            class="fa fa-plus" style="position: relative"></i></a>
                    <a href="{{ route('admin.promoters.notify') }}" class="btn btn-icon btn-info mr-1">إرسال إشعار <i
